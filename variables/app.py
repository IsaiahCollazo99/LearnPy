...
# print(abs(character_age)) # Absolute value
# print(pow(3, 2)) # Exponent 3 ^ 2
# print(max(4, 6)) # returns which number is higher inf length
# print(min(4, 6)) # Returns lower number inf length
# print(round(3.7)) # rounds number
# print(floor(3.7)) # Floors number
# print(ceil(3.7)) # Ceils number
